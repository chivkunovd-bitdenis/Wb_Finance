...
_DEFAULT_TEMPLATE = """Ты помощник для генерации визуала карточки маркетплейса.
Ниже — пожелания продавца (сырой текст, может быть кратким). Учитывай стиль, материалы, цвета и назначение товара при дальнейшей генерации изображений.
