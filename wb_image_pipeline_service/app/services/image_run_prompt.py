...
_DEFAULT_TEMPLATE = """Текст ниже — пожелания пользователя к генерации 4 главных фото карточки Wildberries.

Эти пожелания нужно использовать только на этапе генерации 4 главных фото.
JSON-планировщик должен органично встроить смысл пожеланий в создаваемые промпты, а не копировать текст механически.

Если пожелания пользователя противоречат исходным референсам товара, приоритет у референсов:
нельзя менять категорию, цвет, материал, форму, фасон, конструкцию и ключевые детали товара.

Не используй эти пожелания для генерации 7 дополнительных фото после выбора главного кадра.
