        ...
        {sourceLoading ? (
          ...
          <div style={{ display: 'grid', gap: 14 }}>
            <div style={{ fontSize: 13, color: 'var(--text-secondary)', lineHeight: 1.5 }}>
              ...
              {' '}
              <strong>CTR и конверсии в корзину/заказ</strong> — как в отчёте WB («Конверсия в корзину, %», «Конверсия в заказ, %»): в ячейке число без знака «%», смысл — процентные пункты.
              Конверсии и CTR — процентные пункты как в Excel; по конкурентам — <strong>медиана</strong>. Нули у конкурентов не участвуют.
