...
**Роль:** planner → **следующий шаг:** builder выполняет фазы по `PRODUCT_GEN_TASKS.md` (**v2:** **A → B → C** — каскад изображений без обязательной карточки на старт; товар/WB — отдельно в `PRODUCT_GEN_PRODUCT_STREAM.md`), не перескакивая.  
**Источник нарезки (IMAGE):** `PRODUCT_GEN_TASKS.md` (версия **v2**, 2026-05-13).  
**Нарезка задач по товару / WB:** `PRODUCT_GEN_PRODUCT_STREAM.md` (вне текущей итерации IMAGE).  
**Дата плана:** 2026-05-12.

> **Актуализация (2026-05-13):** UX и бэклог разделены на поток **IMAGE** и **PRODUCT/WB** — см. `PRODUCT_GEN_TASKS.md` v2; задачи товара вынесены в `PRODUCT_GEN_PRODUCT_STREAM.md`. **§2–§4** ниже приведены в соответствие (PG-A.0).
